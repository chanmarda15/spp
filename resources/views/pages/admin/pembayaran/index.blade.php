...
@section('title', 'Entry Pembayaran')
                    ...
                    <!-- <form action="" method="GET" class="">
                        @csrf
                          <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control @error('nisn') is-invalid @enderror" name="nisn" id="nisn" value="{{ request()->get('nisn') ? $siswa->nama : '' }}" readonly required>
